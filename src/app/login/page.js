            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:bg-white focus:border-[#68D0BF] focus:ring-4 focus:ring-teal-500/10 outline-none transition-all duration-200"
                />
              </div>
            </div>
