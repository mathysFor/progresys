    ...
    return (
      <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-teal-50/30 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <div className="w-12 h-12 rounded-full border-4 border-teal-200 border-t-[#3BB8A8] animate-spin" />
                    ...
                    <div className="relative w-16 h-16 shrink-0">
                      <svg className="w-full h-full transform -rotate-90">
                        ...
                        <defs>
                          ...
                          <stop offset="0%" stopColor="#A5ECD0" />
                          <stop offset="100%" stopColor="#3BB8A8" />
                          </linearGradient>
                        </defs>
                      </svg>
